...
if($result=mysqli_query($link, $sql)){
	if(mysqli_num_rows($result)>0){
       while($row=mysqli_fetch_array($result, MYSQL_ASSOC)){
       	  ...
       	  echo "<div class='note $note_id'>
                  <div class='col-xs-5 col-sm-3 delete' style='display:none'>
		...
		echo "<div class = 'alert alert-warning'>You didn't create any notes yet!</div>";
	    exit;
	}
}
else{
