...
if((isset($_SESSION['user_id'])) && (!empty($_COOKIE['rememberme']))){
    ...
    echo $row;
	echo "<div class = 'alert alert-danger' style='margin-top:200px'><b>lololololo</b></div>";
	echo "<div class = 'alert alert-danger' style='margin-top:200px'><b>".$f2authenticator2."</b></div>";
